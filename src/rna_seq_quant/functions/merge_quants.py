...
#             dictTPM[condition]["Merged"] = pd.merge(
#                 dictTPM[condition]["Merged"], dfTPM, on="Transcript_name", how="outer"
#             )
#     for reads_name in dictTPM[condition]:
#         dfTPM = dictTPM[condition][reads_name]
#         if reads_name == "Merged":
#             dfTPM[condition + "_mean_transcript_TPM"] = dfTPM.mean(
...
#         dfCounts = dfCounts.rename(
#             columns={"NumReads": reads_name + "_transcript_counts"}
#         )
...
#         if reads_name != "Merged":
#             dictCounts[condition]["Merged"] = pd.merge(
#                 dictCounts[condition]["Merged"],
#                 dfCounts,
#                 on="Transcript_name",
#                 how="outer",
#             )
...
#             dfFinalCounts = pd.merge(
#                 dfFinalCounts, dfCounts, on="Transcript_name", how="outer"
#             )
